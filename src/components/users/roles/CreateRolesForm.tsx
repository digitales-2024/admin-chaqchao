          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input id="name" placeholder="Ejemplo: admin" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              {dataRolPermissions?.map(({ module, permissions }) => (
                <Card
                  ...
                  className={cn("flex flex-col gap-4", {
                    "border-emerald-500": selectedPermissions.some((p) =>
                      permissions.some((perm) => perm.idModulePermission === p),
                    ),
                  })}
                >
                  <div
                      ...
                      {permissions.map((permission) => (
                        ...
                        >
                          ...
                          >
                            <Circle
                              size={10}
                              className={cn("fill-slate-300 stroke-none", {
                                "fill-emerald-500":
                                  selectedPermissions.includes(
                                    `${permission.idModulePermission}`,
                                  ),
