...
export const CardBussiness = () => {
  ...
  return (
    <Card className="mx-auto hidden w-full overflow-hidden md:block">
      <CardHeader className="relative flex h-56 flex-col items-center justify-center overflow-hidden bg-gradient-to-t from-transparent to-chaqchao-midning-green/80 pb-2">
